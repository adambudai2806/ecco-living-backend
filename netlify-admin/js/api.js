...
class APIClient {
    constructor() {
        ...
        this.baseURL = window.API_BASE_URL || this.getApiBaseUrl();
    ...
    getApiBaseUrl() {
        ...
        // For Netlify deployments, use the production API URL
        // This can be overridden by setting window.API_BASE_URL
        return 'https://your-backend-url.com/api'; // You'll need to replace this
    }
    ...
    async request(endpoint, options = {}) {
        ...
        try {
            ...
            // Special handling for HTTPS -> HTTP blocking
            if (error.message.includes('fetch') || error.name === 'TypeError') {
                throw new Error('Connection failed: HTTPS to HTTP blocked by browser. Please use HTTPS backend or local development.');
            }
